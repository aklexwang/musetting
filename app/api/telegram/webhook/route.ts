...
export async function POST(request: Request) {
  ...
  try {
    ...
    // 키보드 버튼 "Admin" 탭 → 인라인 버튼 (callback_data: 탭 시 링크 열고 메시지 자동 삭제)
